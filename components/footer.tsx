        ...
        <div className="grid md:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-xs">
              The portfolio data layer for VC and PE.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#comparison" className="text-muted-foreground hover:text-foreground transition-colors text-sm">Pricing</a></li>
